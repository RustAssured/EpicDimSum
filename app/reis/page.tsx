...
const updates = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph' as const, text: 'Daarna samen naar Fu Dumplings. De tweede keer al. De sticker laten zien aan het team, enthousiaste reacties. Volgende keer gaat hij op het raam.' },
